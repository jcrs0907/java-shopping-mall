...
<div class="content_box">
	<div class="join_agreement_wrap">
		...
		<div class="member_cont">
			<form id="formTerms" name="formTerms" method="post" action="<%=request.getContextPath()%>/index.jsp?workgroup=member&work=join_member_form">
			<input type="hidden" name="join" value="1">
			
				<div class="join_agreement_cont">

					<div class="join_agreement_box first">
						<label><input class="j-checkbox" type="checkbox" id="agreeAll">
						<span id="textAll">디마르3의 모든 약관을 확인하고 전체 동의합니다.</span></label>
						<!-- <span>(전체동의, 선택항목도 포함됩니다.)</span> -->
					</div>
					<!-- //join_agreement_box -->

					<div class="join_agreement_box js_terms_view">
							<label><input type="checkbox" class="j-sub-checkbox" id="agreeTerm1" name="agreementInfo" class="require" >
							<strong>(필수)</strong> 이용약관</label>
							<span><a href="<%=request.getContextPath()%>/index.jsp?workgroup=member&work=agreement" target="_blank">전체보기</a></span>
	...
	<h4>제1조(목적)</h4>
	<p class="txt01">
		이 약관은 (주)자연물질연구소 회사(전자거래 사업자)가 운영하는 디마르3 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리 · 의무 및 책임사항을 규정함을 목적으로 합니다.
		<br>
		※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」
	</p>
	<h4>제2조(정의)</h4>
	<ol class="circle">
		<li>① "몰"이란 (주)자연물질연구소 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
	...
	<ol>
		<li>① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호 · 모사전송번호 · 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보 보호책임자등을 이용자가 쉽게 알 수 있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
	...
	<ol class="circle">
		<li>① "몰"은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다.
			<br>다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.
			<ol class="no">
	...
	<h4>제11조(지급방법)</h4>
	<p class="txt01">"몰"에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, "몰"은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.</p> 
	<ol class="no">
	...
	<h4>제14조(환급)</h4>
	<p class="txt01">"몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다. </p>
	...
	<h4>제17조(적립금)</h4>
	<ol class="circle">
		<li>① 회사는 서비스 정책에 따라 회원에게 적립금을 지급하며, 적립금의 적립기준, 사용기간, 사용조건 및 제한에 관한 사항은 서비스 화면에 별도로 게시하거나 통지합니다.</li>
		<li>② 적립금의 사용조건 및 한도에 관한 사항은 회사의 정책에 따라 달라질 수 있습니다.</li>
		<li>③ 적립금의 사용기간은 원칙적으로 적립 후 1년이며, 유효기간 동안 사용하지 않을 경우 자동으로 소멸됩니다. 다만, 마케팅 기타 프로모션 등을 통하여 지급되거나 사전특약이 설정된 적립금의 사용기간은 별도로 정하여진 기준에 의합니다.</li>
		<li>④ 회원이 부정한 방법(비정상적인 방법으로 추천인을 모집하는 등의 방법)으로 적립금을 적립·사용하거나 타인에게 처분한 사실이 확인될 경우, 회사는 적립금 회수, 회원계약 해지, 손해배상의 청구, 형사 고발 등의 조치를 취할 수 있습니다.</li>
		<li>⑤ 1년이상 서비스를 미사용 시 (단, 회원이 별도 기간을 선택한 경우 그에 따름) 개인정보 유효 기간제가 적용되며, 휴면 회원으로 전환될 경우 적립금은 자동 소멸되며, 회원이 다시 재로그인을 통해 회원 정보를 복구하더라도 적립금은 복구되지 않습니다.</li>
		<li>⑥ 회원탈퇴 시 적립금은 자동 소멸되며, 탈퇴 후 재가입하더라도 소멸된 적립금은 복구되지 않습니다.</li>
	</ol>
	<h4>제18조(개인정보보호)</h4>
	<ol class="circle">
		<li>
		...
		<li>④ "몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보 보호책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.</li>
	...
	<h4>제21조(이용자의 의무)</h4>
	<p class="txt01">이용자는 다음 행위를 하여서는 안됩니다. </p>
	<ol class="no">
	...
	<h4>[부칙]</h4>
	<p class="txt01">1. 이 약관은 2018년 03월 19일부터 적용됩니다.</p>
	<p class="txt01"><a href="http://demar3.co.kr/main/html.php?htmid=service/_inc_agreement.html" target="_blank">이용약관ver1 보러가기</a></p>
</div>
						</div>
						<!-- //agreement_box -->
					</div>
					...
					<div class="join_agreement_box js_terms_view">
							<label><input type="checkbox" class="j-sub-checkbox" id="agreeTerm2" name="privateApproval" class="require" >
							<strong>(필수)</strong> 개인정보 수집 및 이용 </label>
...
<div class="joinAgreement">
	<div class="agreeArea">
		<ul>
			<li>서비스 제공을 위한 최소한의 개인정보이므로 동의를 해주셔야 서비스를 이용하실 수 있습니다.</li>
			<li>선택적으로 수집되는 정보에 대한 동의는 거부하실 수 있으며, 거부하시더라도 회원가입, 상품주문 등 기보 서비스 이용에는 제한을 받지않습니다.</li>
		</ul>
	</div>
		...
		<table style="border-spacing:0px;border-collapse:collapse;" class="agree">
			...
			<tbody>
				<tr>
					<td>회원계정의 생성</td>
					<td>ID, 비밀번호, 생년월일</td>
					<td>회원 탈퇴 후 6개월 까지</td>
				</tr>
				<tr>
					<td>중복가입 확인, 고지의 전달, 의사소통 경로의 확보</td>
					<td>성명, 휴대폰번호, 생년월일, 이메일 주소</td>
					<td>회원 탈퇴 후 6개월 까지</td>
				</tr>
			</tbody>
		</table>
					...
					<div id="checkError" style="display: none;">
						<span style="color: red; padding-left: 60px;font-weight: bold;">(주의)</span>
						<strong>이용약관과 개인정보 수집 및 이용에 대한 안내를 모두 동의해주세요.</strong>
					</div>
				</div>
				<!-- //join_agreement_cont -->
				...
				<div class="btn_center_box">
					<button type="button" id="btnPrevStep" class="btn_member_prev">이전</button>
					<button type="submit" id="btnNextStep" class="btn_member_next">
						다음
					</button>
				</div>
				<!-- //btn_member_sec -->
...
<script type="text/javascript">
	...
	$("#agreeAll").change(function() {
		if($(this).is(":checked")) {
			$(".j-sub-checkbox").prop("checked", true);
			$("#checkError").css("display","none");
		} else {
			$(".j-sub-checkbox").prop("checked", false);	
		}
	});
	
	
	
	// id - agreeTerm1, agreeTerm2
			
	$("#formTerms").submit(function(){
		var submitResult=true;
		
		$("#checkError").css("display","none");
		
		
		if(!$("#agreeTerm1").is(":checked") || !$("#agreeTerm2").is(":checked")){
