...
<div class="content_box">
    ...
    <!-- //item_info_box -->
     ...
     <!-- 상단 비쥬얼 -->
    <div class="goods_wrap goods_35">
        <div class="top_box">
            <div class="top_visual bg35">
            </div>
...
<!-- 상품상세 -->
<div class="item_goods_sec view35">
    ...
    <div class="detail_cont bg">
        <div id="detail" class="descript_cont">
            <div class="txt-manual">
                ...
                <!-- 35. 시타 듀 1.6 버닝 2제 -->
		<img src="https://demar3-src.s3.ap-northeast-2.amazonaws.com/front/mime/img/goods/thumb_35.jpg" style="display:none;">
		...
		<div class="detail_wrap">
			<div class="tab_contents">
				<div class="visual_box bg35">
					<div class="img_title">
						<img src="/data/skin/front/mime/img/goods/new/35/visual_title.png" alt="">
					</div>
				</div>
				...
				<div class="detail_contents mb150">
					<div class="detail_title">
						여드름성 피부에 적합한 저자극 기능성 앰플
					</div>
					<div class="detail_img_box">
						<img src="/data/skin/front/mime/img/goods/new/35/detail_img1.jpg" alt="">
						<div class="txt" style="font-size:10px;">
				...
				<div class="detail_step_wrap">
					<div class="detail_video_box bg35"></div>
					<div class="detail_step" style="padding-top:70px;">
						<div class="detail_img_box" style="margin-bottom:60px;">
							<img src="/data/skin/front/mime/img/goods/new/35/detail_info.png" alt="">
						</div>
			...
			<div class="tab_contents">
				<div class="step_contents">
					<div class="step_img_box">
						<img src="/data/skin/front/mime/img/goods/new/35/detail_step.png" alt="">
					</div>
					<div class="step_text_box">
						...
						<img src="/data/skin/front/mime/img/goods/new/35/detail_use.png" alt="">
					</div>
				</div>
			</div>
		</div>
            ...
            <div id="qna" class="qna_cont">
                ...
                <div class="sort">
                    <div class="right btn_up">
                        <a href="javascript:gd_open_write_popup('goodsqa', '35')" class="write">문의 작성하기</a>
                    </div>
                </div>
        ...
        <div class="detail_inner">
            ...
            <table>
                ...
                <tr>
                    <th>전성분</th>
                    <td>
                        병풀추출물, 글리세린, 메틸프로판다이올, 글리세레스-26, 나이아신아마이드, 다이프로필렌글라이콜, 메틸글루세스-20, 펜틸렌글라이콜, 1,2-헥산다이올, 베타인, 다시마추출물, 한련초잎추출물, 쇠비름추출물, 녹차추출물, 서양산딸기추출물, 연꽃추출물, 황련추출물, 오레가노잎추출물, 편백잎추출물, 흰버드나무껍질추출물, 도둑놈의지팡이뿌리추출물, 인동덩굴꽃추출물, 당느릅나무뿌리추출물, 도꼬마리열매추출물, 마늘추출물, 생강추출물, 스페인감초뿌리추출물, 탱자추출물, 퉁퉁마디추출물, 락토바실러스/콩발효추출물, 육계나무껍질추출물, 황금추출물, 은행나무잎추출물, 동백나무잎추출물, 로켓잎추출물, 밀싹추출물, 브로콜리싹추출물, 자주개자리추출물, 유칼립투스잎추출물, 베르가모트오일, 소듐하이알루로네이트, 하이드로제네이티드레시틴, 옥틸도데세스-16, 아크릴레이트/C10-30알킬아크릴레이트크로스폴리머, 정제수, 암모늄아크릴로일다이메틸타우레이트/브이피코폴리머, 트로메타민, 리모넨, 아데노신, 프룩토올리고사카라이드, 베타-글루칸, 부틸렌글라이콜, 판테놀, 하이드롤라이즈드하이알루로닉애씨드, 폴리쿼터늄-51, 칸디다 봄비콜라/글루코오스/메틸레이프씨데이트발효물, 팔미토일트라이펩타이드-5, 마데카소사이드, 노나펩타이드-1, 아세틸헥사펩타이드-8, 리날룰, 카퍼트라이펩타이드-1, 트라이펩타이드-1, 팔미토일테트라펩타이드-7, 팔미토일트라이펩타이드-1, 팔미토일펜타펩타이드-4, 헥사펩타이드-9, 에탄올, 카프릴릭/카프릭트라이글리세라이드, 다이소듐이디티에이, 소듐스테아로일글루타메이트, 소듐아스코빌포스페이트, 에스에이치-올리고펩타이드-1, 카프릴릴글라이콜, 에틸헥실글리세린
                    </td>
                </tr>
                <tr>
                    <th>사용방법</th>
